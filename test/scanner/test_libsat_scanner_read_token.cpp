...
TEST(assignment)
{
    ...
    /* this token should be ASSIGNMENT. */
    TEST_EXPECT(LIBSAT_SCANNER_TOKEN_TYPE_ASSIGNMENT == token);
...
/**
 * Scan a simple logic expression with spaces.
 */
TEST(logic_expression1)
{
    allocator* alloc;
    libsat_context* context;
    libsat_scanner* scanner;
