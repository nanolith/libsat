...
/**
 * \brief The name is larger than what we support.
 */
#define ERROR_LIBSAT_PARSER_VARIABLE_NAME_TOO_LARGE \
    STATUS_CODE(1, LIBSAT_COMPONENT_PARSER, 0x0006)

/**
 * \brief We encountered an incomplete expression.
 */
#define ERROR_LIBSAT_PARSER_INCOMPLETE_EXPRESSION \
    STATUS_CODE(1, LIBSAT_COMPONENT_PARSER, 0x0007)

/**
 * \brief The parser encountered unbalanced parentheses.
 */
#define ERROR_LIBSAT_PARSER_UNBALANCED_PARETHESES \
    STATUS_CODE(1, LIBSAT_COMPONENT_PARSER, 0x0008)
