/**
 * \file scanner/libsat_ast_node_create_as_statement.c
 *
 * \brief Create a statement AST node.
 *
    ...
    LIBSAT_SYM(libsat_ast_node)* child)
{
    ...
    tmp->type = LIBSAT_PARSER_AST_NODE_TYPE_STATEMENT;
    tmp->value.unary = child;
